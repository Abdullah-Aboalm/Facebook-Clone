"use strict";
let carouselImgTxt = document.querySelector(".carousel .text span");
let Imgs = Array.from(document.querySelectorAll(".carousel .image img"));
let carouselNext = 0;
let nextBtn = document.querySelector(".carousel .image .next");
let prevBtn = document.querySelector(".carousel .image .prev");
let bullets = document.querySelector(".carousel .image .bullets");
