"use strict";
// all reactions
let allReactionsGroups = document.querySelector("ul.medias .all-reactions");
let chooseReactionGroups = document.querySelector("ul.medias li.choose-reaction");
let chooseReactionSpanGroups = chooseReactionGroups.querySelector("span");
let chooseReactionImgGroups = chooseReactionGroups.querySelector("img");
...
// reactions
let reactionCountContGroups = document.querySelector("ul.medias .reactions-count");
let reactionCountImgGroups = reactionCountContGroups.querySelector("img");
